...
function AddListing() {
    ...
    const GetListofCarById = async () => {
        try {
            const response = await fetch(`https://wheelsanddeals.onrender.com/api/cars/getcarbyid?recordId=${recordId}`, {
                method: 'GET',
                headers: {
    ...
    try {
        const response = await fetch('https://wheelsanddeals.onrender.com/api/cars/upload-images', {
            method: 'POST',
            body: imageformData,
        });
        ...
        if (mode == 'edit') {
            ...
            try {
                const response = await fetch(`https://wheelsanddeals.onrender.com/api/cars/updateListing?id=${recordId}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json',
                    },
            ...
            try {
                const response = await fetch('https://wheelsanddeals.onrender.com/api/cars/addListing', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
