...
const ENDPOINT = 'https://wheelsanddeals.onrender.com';
...
export default function Chatbox() {
  ...
  const fetchMessages = async () => {
    try {
      ...
      const response = await fetch(`https://wheelsanddeals.onrender.com/api/chat/fetchmessages/${selectedChat._id}`, {
        method: "GET",
      });
      if (response.ok) {
  ...
  const sendMessage = async (e) => {
    if (e.key === 'Enter') {
      ...
      if (newMessage) {
        ...
        try {
          setNewMessage("");
          const response = await fetch(`https://wheelsanddeals.onrender.com/api/chat/sendmessage`, {
            method: "POST",
            headers: {
